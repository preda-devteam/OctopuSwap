...
BENCHMARK_DIR="$PROJECT_ROOT/client/benchmark"
...
# cargo run --release -- --parallel --tx_num 1000 --acc_num 400 > "$RESULT_DIR/benchmark_amm_parallelization_1000.log"
# cargo run --release -- --tx_num 1000 --acc_num 400 > "$RESULT_DIR/benchmark_amm_1000.log"
